...
// Решение с более коротким телом, тоже имеет право быть:
const calculateBalanceForUserV2 = (user: User): number =>
  user.transactions.reduce((sum, transaction) => sum + transaction.diff, user.startBalance);
